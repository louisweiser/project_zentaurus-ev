export const projectData = [
  {
    name: "Inklusive",
    image: "/project_inklusive.jpg",
    domain: "inklusive",
    description:
      "Jeden Sommer veranstalten wir eine 3-wöchige Förderzeit in den Schulferien. Eine Gemeinschaft von Kindern, Jugendlichen und Erwachsenen.",
    text: [
  ...
  {
    name: "Hilfe im Alltag",
    image: "/project_hilfeimalltag.jpg",
    domain: "hilfeimalltag",
    description:
      "Es geht um Unterstützung im Alltag, um die pflegende Person zu entlasten. Es entspricht Leistungen wie Fensterputzen, die Wohnung in Ordnung halten, Besorgungen und vieles mehr.",
    text: [
      ...
      "Dies betrifft zum Beispiel Leistungen, wie: - Fensterputzen - Wohnung in Ordnung halten - Besorgungen und vieles mehr.",
